        ...
        <Container>
            <Row>
                ...
                <Col lg='3'>
                    ...
                    <ListGroup className="footer__quink-links">
                                ...
                                <ListGroupItem  className='ps-0 border-0 d-flex align-items-center gap-3'>
                                    ...
                                    <p className="mb-0">Robespierre, Bagnolet</p>
                                </ListGroupItem>
                                ...
                                <ListGroupItem  className='ps-0 border-0 d-flex align-items-center gap-3'>
                                    ...
                                    <p className="mb-0">libasse.g.laye@gmail.com</p>
                                </ListGroupItem>
                                ...
                                <ListGroupItem  className='ps-0 border-0 d-flex align-items-center gap-3'>
                                    ...
                                    <p className="mb-0">+33 7 67 88 62 38</p>
                                </ListGroupItem>
                ...
                <Col lg='12' className="text-center pt-5">
                    <p className="copyright">Copyright {year}, design and develop by Libasse. Tous droits réservés</p>
                </Col>
            </Row>
        </Container>
    </footer>   
